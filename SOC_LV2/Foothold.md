...
|Known cloud-based services	|
|Passing traffic through known web applications such as Google Drive| Telegram| and Discord.|
|Encrypted custom HTTP/s server	|
|Using a self-hosted server with a well-groomed domain passing encrypted traffic.|
