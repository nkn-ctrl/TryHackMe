...
|```tcp.dstport == 80```|Show all TCP packets sent to port 80	|```udp.dstport == 5353```|Show all UDP packets sent to port 5353|<br>
- Cobalt Strike use HTTP:```tcp.port == 8080```,HTTPS ```tcp.port == 8443```<br>
